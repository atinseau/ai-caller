...
export interface paths {
  ...
  "/conversations/{conversation_id}/items": {
     ...
     */
    post: operations["createConversationItems"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/conversations/{conversation_id}/items/{item_id}": {
     ...
     */
    delete: operations["deleteConversationItem"];
    options?: never;
    head?: never;
    patch?: never;
    trace?: never;
  ...
  "/realtime/calls": {
     ...
     */
    post: operations["create-realtime-call"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/realtime/calls/{call_id}/accept": {
     ...
     *     handle it.
     */
    post: operations["accept-realtime-call"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/realtime/calls/{call_id}/hangup": {
     ...
     *     WebRTC.
     */
    post: operations["hangup-realtime-call"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/realtime/calls/{call_id}/refer": {
     ...
     */
    post: operations["refer-realtime-call"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/realtime/calls/{call_id}/reject": {
     ...
     */
    post: operations["reject-realtime-call"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/realtime/client_secrets": {
     ...
     */
    post: operations["create-realtime-client-secret"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/videos/{video_id}/content": {
     ...
     */
    get: operations["RetrieveVideoContent"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  "/videos/{video_id}/remix": {
     ...
     */
    post: operations["CreateVideoRemix"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/responses/input_tokens": {
     ...
     */
    post: operations["Getinputtokencounts"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/chatkit/sessions/{session_id}/cancel": {
     ...
     */
    post: operations["CancelChatSessionMethod"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/chatkit/sessions": {
     ...
     */
    post: operations["CreateChatSessionMethod"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  "/chatkit/threads/{thread_id}/items": {
     ...
     */
    get: operations["ListThreadItemsMethod"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
  ...
  "/chatkit/threads/{thread_id}": {
     ...
     */
    get: operations["GetThreadMethod"];
    put?: never;
    post?: never;
    /**
     ...
     */
    delete: operations["DeleteThreadMethod"];
    options?: never;
    head?: never;
    patch?: never;
    trace?: never;
  ...
  "/chatkit/threads": {
     ...
     */
    get: operations["ListThreadsMethod"];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
...
export interface components {
  schemas: {
    ...
    AuditLog: {
      ...
      "login.succeeded"?: Record<string, never>;
      /** @description The details for events with this `type`. */
      "login.failed"?: {
      ...
      /** @description This event has no additional fields beyond the standard audit log attributes. */
      "logout.succeeded"?: Record<string, never>;
      /** @description The details for events with this `type`. */
      "logout.failed"?: {
        /** @description The error code of the failure. */
        error_code?: string;
    ...
    CodeInterpreterTool: {
       ...
       */
      container: string | components["schemas"]["CodeInterpreterContainerAuto"];
    };
    /**
    ...
    DeletedConversation: components["schemas"]["DeletedConversationResource"];
    ...
    Drag: {
       ...
       *     ```
       */
      path: components["schemas"]["DragPoint"][];
    };
    /**
     * Input message
    ...
    EvalRunOutputItem: {
      ...
      results: components["schemas"]["EvalRunOutputItemResult"][];
    ...
    RealtimeBetaClientEventResponseCreate: {
      ...
      response?: components["schemas"]["RealtimeBetaResponseCreateParams"];
    };
    /**
    ...
    RealtimeBetaServerEventResponseCreated: {
      ...
      response: components["schemas"]["RealtimeBetaResponse"];
    };
    /**
    ...
    RealtimeCallCreateRequest: {
       ...
       *     request.
       */
      session?: components["schemas"]["RealtimeSessionCreateRequestGA"];
    };
    /**
    ...
    RealtimeResponse: {
      ...
      audio?: {
        output?: {
          ...
          format?: components["schemas"]["RealtimeAudioFormats"];
          /**
           * @description The voice the model uses to respond. Voice cannot be changed during the
           *     session once the model has responded with audio at least once. Current
           *     voice options are `alloy`, `ash`, `ballad`, `coral`, `echo`, `sage`,
    ...
    RealtimeSession: {
      ...
      input_audio_noise_reduction?: {
        type?: components["schemas"]["NoiseReductionType"];
      };
      /**
    ...
    RealtimeSessionCreateRequest: {
       ...
       */
      max_response_output_tokens?: number | "inf";
      truncation?: components["schemas"]["RealtimeTruncation"];
      prompt?: components["schemas"]["Prompt"];
    };
    /**
    ...
    RealtimeSessionCreateRequestGA: {
      ...
      audio?: {
        input?: {
          ...
          transcription?: components["schemas"]["AudioTranscription"];
          /**
           * @description Configuration for input audio noise reduction. This can be set to `null` to turn off.
           *     Noise reduction filters audio added to the input audio buffer before it is sent to VAD and the model.
           *     Filtering the audio can improve VAD and turn detection accuracy (reducing false positives) and model performance by improving perception of the input audio.
    ...
    RealtimeTranscriptionSessionCreateRequest: {
      ...
      input_audio_transcription?: components["schemas"]["AudioTranscription"];
      /**
    ...
    CreateConversationBody: {
      ...
      items?: components["schemas"]["InputItem"][] | null;
    };
    ...
    VideoResource: {
      ...
      model: components["schemas"]["VideoModel"];
      ...
      size: components["schemas"]["VideoSize"];
      /** @description Duration of the generated clip in seconds. */
      seconds: components["schemas"]["VideoSeconds"];
      remixed_from_video_id: string | null;
      error: components["schemas"]["Error-2"] | null;
    };
    VideoListResource: {
      /**
       * @description The type of object returned, must be `list`.
      ...
      data: components["schemas"]["VideoResource"][];
      first_id: string | null;
      last_id: string | null;
      /** @description Whether there are more items available. */
      has_more: boolean;
    ...
    /** @enum {string} */
    VideoContentVariant: "video" | "thumbnail" | "spritesheet";
    /**
    ...
    TokenCountsBody: {
      model?: string | null;
      input?: (string | components["schemas"]["InputItem"][]) | null;
      previous_response_id?: string | null;
    ...
    ChatkitWorkflow: {
      ...
      tracing: components["schemas"]["ChatkitWorkflowTracing"];
    };
    /**
     * Rate limits
    ...
    ChatSessionChatkitConfiguration: {
      ...
      automatic_thread_titling: components["schemas"]["ChatSessionAutomaticThreadTitling"];
      /** @description Upload settings for the session. */
      file_upload: components["schemas"]["ChatSessionFileUpload"];
      /** @description History retention configuration. */
      history: components["schemas"]["ChatSessionHistory"];
    };
    /**
    ...
    ChatSessionResource: {
      ...
      workflow: components["schemas"]["ChatkitWorkflow"];
      /** @description User identifier associated with the session. */
      user: string;
      /** @description Resolved rate limit values. */
      rate_limits: components["schemas"]["ChatSessionRateLimits"];
      ...
      chatkit_configuration: components["schemas"]["ChatSessionChatkitConfiguration"];
    };
    /**
     * Tracing Configuration
     * @description Controls diagnostic tracing during the session.
    ...
    WorkflowParam: {
      ...
      tracing?: components["schemas"]["WorkflowTracingParam"];
    };
    /**
    ...
    ChatkitConfigurationParam: {
      ...
      automatic_thread_titling?: components["schemas"]["AutomaticThreadTitlingParam"];
      ...
      file_upload?: components["schemas"]["FileUploadParam"];
      ...
      history?: components["schemas"]["HistoryParam"];
    };
    /**
    ...
    CreateChatSessionBody: {
      ...
      workflow: components["schemas"]["WorkflowParam"];
      ...
      expires_after?: components["schemas"]["ExpiresAfterParam"];
      /** @description Optional override for per-minute request limits. When omitted, defaults to 10. */
      rate_limits?: components["schemas"]["RateLimitsParam"];
      /** @description Optional overrides for ChatKit runtime configuration features */
      chatkit_configuration?: components["schemas"]["ChatkitConfigurationParam"];
    };
    /**
     * User message input
    ...
    /** @enum {string} */
    ClientToolCallStatus: "in_progress" | "completed";
    /**
     * Client tool call
    ...
    ClientToolCallItem: {
      ...
      status: components["schemas"]["ClientToolCallStatus"];
    ...
    ThreadItemListResource: {
      ...
      object: "list";
      /** @description A list of items */
      data: components["schemas"]["ThreadItem"][];
      first_id: string | null;
      last_id: string | null;
      /** @description Whether there are more items available. */
      has_more: boolean;
    ...
    ThreadListResource: {
      ...
      object: "list";
      /** @description A list of items */
      data: components["schemas"]["ThreadResource"][];
      first_id: string | null;
      last_id: string | null;
      /** @description Whether there are more items available. */
      has_more: boolean;
...
export interface operations {
    ...
    requestBody: {
      content: {
        "application/json": {
          ...
          items: components["schemas"]["InputItem"][];
        };
      };
    };
    responses: {
  ...
  "create-realtime-call": {
    ...
    requestBody: {
      content: {
        "multipart/form-data": components["schemas"]["RealtimeCallCreateRequest"];
  ...
  "accept-realtime-call": {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["RealtimeSessionCreateRequestGA"];
      };
    };
    responses: {
  ...
  "refer-realtime-call": {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["RealtimeCallReferRequest"];
      };
    };
    responses: {
  ...
  "reject-realtime-call": {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["RealtimeCallRejectRequest"];
      };
    };
    responses: {
  ...
  "create-realtime-client-secret": {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["RealtimeCreateClientSecretRequest"];
      };
    };
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["RealtimeCreateClientSecretResponse"];
        };
      };
    };
  };
  ...
  deleteConversation: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["DeletedConversationResource"];
        };
      };
    };
  };
  ListVideos: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["VideoListResource"];
        };
      };
    };
  };
  createVideo: {
    ...
    requestBody?: {
      content: {
        "multipart/form-data": components["schemas"]["CreateVideoBody"];
        "application/json": components["schemas"]["CreateVideoBody"];
      };
    };
    responses: {
      /** @description Success */
  ...
  DeleteVideo: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["DeletedVideoResource"];
        };
      };
    };
  };
  RetrieveVideoContent: {
    parameters: {
      query?: {
        ...
        variant?: components["schemas"]["VideoContentVariant"];
      };
      header?: never;
      path: {
  ...
  CreateVideoRemix: {
    ...
    requestBody?: {
      content: {
        "multipart/form-data": components["schemas"]["CreateVideoRemixBody"];
        "application/json": components["schemas"]["CreateVideoRemixBody"];
      };
    };
    responses: {
      /** @description Success */
  ...
  Getinputtokencounts: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["TokenCountsBody"];
        "application/x-www-form-urlencoded": components["schemas"]["TokenCountsBody"];
      };
    };
    responses: {
      /** @description Success */
      200: {
        ...
        content: {
          "application/json": components["schemas"]["TokenCountsResource"];
        };
      };
    };
  };
  CancelChatSessionMethod: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["ChatSessionResource"];
        };
      };
    };
  };
  ...
  ListThreadItemsMethod: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["ThreadItemListResource"];
        };
      };
    };
  };
  ...
  DeleteThreadMethod: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["DeletedThreadResource"];
        };
      };
    };
  };
  ListThreadsMethod: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["ThreadListResource"];
        };
      };
    };
  };
